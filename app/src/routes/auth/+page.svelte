...
<form method="POST" action="?/login">
	...
	>
		...
		<div class="bg-muted relative hidden h-full flex-col p-10 text-white lg:flex dark:border-r">
			...
			></div>
			<div class="relative z-20 flex items-center text-lg font-medium">StreamX</div>
			<div class="relative z-20 mt-auto">
				<blockquote class="space-y-2">
					<p class="text-lg">
						&ldquo;This library has saved me countless hours of work and helped me deliver realtime
						data to my dashboards faster than ever before. Highly recommended!&rdquo;
					</p>
					<footer class="text-sm">Sir Lewis</footer>
				</blockquote>
			</div>
		</div>
		<div class="lg:p-8">
